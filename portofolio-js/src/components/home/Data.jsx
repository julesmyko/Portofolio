...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Jules 
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      <p className="home__description">Engineering student learning how to code in order to get an internship at a financial firm</p>
