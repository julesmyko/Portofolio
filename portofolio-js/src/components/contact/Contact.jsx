...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_utxaiei', 'template_kyk4fz4', form.current, {
        publicKey: 'uKF9Ag9tC-Va9RDWv',
      })
      .then(
        () => {
          console.log('SUCCESS!');
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">00 00 00 00 00</span>

              <a href="https://api.whatsapp.com/send?phone=62642545345346&text=Hello, more information!" className="contact__button">Write me<i className="bx bx-right-arrow-alt contact__button-icon"></i></a>
            </div>
